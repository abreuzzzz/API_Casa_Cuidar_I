...
df_receber = ler_planilha_por_id("Financeiro_contas_a_receber_Casa_Cuidar_2")
df_pagar = ler_planilha_por_id("Financeiro_contas_a_pagar_Casa_Cuidar_2")
...
planilha_saida = client.open_by_key(planilhas_ids["Financeiro_Completo_Casa_Cuidar_2"])
